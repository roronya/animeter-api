...
ActiveRecord::Schema.define(version: 2018_05_02_091505) do
  ...
  create_table "production_companies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "watcheds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "comment"
    t.date "watched_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
